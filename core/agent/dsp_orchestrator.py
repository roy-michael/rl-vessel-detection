...
class ActiveStatesDict(dict):
    ...
    Intercepts mutations to dynamically spawn or terminate VesselTrackProcessor instances.
    """
    ...
    def __setitem__(self, key, value):
        ...
        # Spawn the child VesselTrackProcessor when a new active state is added
...
class DSPOrchestrator:
    """
    The Digital Signal Processing (DSP) Orchestrator.
    This component acts as the deterministic DSP pipeline for the vessel tracker.
    It observes the raw acoustic data streamer, performs NMF feature extraction, 
    and manages the lifecycle of individual VesselTrackProcessor instances.
    """
