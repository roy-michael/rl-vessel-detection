...
class VesselTrackingRLEnv:
    ...
    Attributes:
        tracker (DispatcherAgent): The dispatcher agent representing the central tracking coordinator.
    ...
    def __init__(self, tracker, reward_calculator=None):
        ...
        Args:
            tracker (DispatcherAgent): The parent coordinator tracking active vessel stages.
