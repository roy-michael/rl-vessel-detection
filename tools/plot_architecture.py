...
def draw_ecosystem_diagram():
    ...
    # Dispatcher
    draw_box(3.5, 5.0, 2.5, 1.2, "DSPOrchestrator\n(NMF Peak Extraction & \nSpectral Clustering)", "dsp")
    
    # Gym Wrapper
    draw_box(7.0, 5.0, 2.4, 1.2, "TrackingMDPEnv\n(Gym / MDP Interface)", "env")
    ...
    # Child agents
    draw_box(7.0, 0.5, 2.4, 1.0, "VesselTrackProcessor 1\n(Vessel Track A)", "dsp")
    draw_box(3.5, 0.5, 2.5, 1.0, "VesselTrackProcessor 2\n(Vessel Track B)", "dsp")
